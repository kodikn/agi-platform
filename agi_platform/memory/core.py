...
class DurableMemoryStore:
    ...
    def store(
        ...
        embedding_id = (
            f"qdrant:{digest}" if self.qdrant_available else None
        )
    ...
    def _to_record(
        ...
        return {
            ...
            "content": row.content,
            "memory_type": row.metadata_json.get(
                "memory_type",
                "semantic",
            ),
...
@dataclass
class MemoryLayer:
    store_backend: DurableMemoryStore = field(
        default_factory=DurableMemoryStore
    )
    ...
    def store(
        ...
        return self.store_backend.store(
            context,
            content,
            memory_type,
            metadata,
    ...
    def search(
        ...
        return self.store_backend.search(
            context,
            query,
            limit,
        )
    ...
    def update(
        ...
        return self.store_backend.update(
            context,
            memory_id,
            content,
            expected_version,
    ...
    def rollback(
        ...
        return self.store_backend.rollback(
            context,
            memory_id,
            version,
        )
