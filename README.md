...
- Level 7: OpenHands-style action/observation sandbox execution with event logs, workspace isolation, and metrics.
- Level 8: entity/relationship knowledge graph operations and search.
- Level 9: LangGraph-style stateful workflow planning, interrupt/resume, event streaming, checkpointing, and recovery-ready state.
...
- [OpenHands and LangGraph integrations](docs/integrations.md)
